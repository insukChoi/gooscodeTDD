...
public class XMPPAuctionHouse implements AuctionHouse {
  ...
  public XMPPAuctionHouse(XMPPConnection connection) throws Exception {
  ...
  private Logger makeLogger() throws Exception {
  ...
  private FileHandler simpleFileHandler() throws Exception {
    try { 
      FileHandler handler = new FileHandler(LOG_FILE_NAME); 
      handler.setFormatter(new SimpleFormatter()); 
      return handler; 
    } catch (Exception e) { 
      throw new Exception("Could not create logger FileHandler ", e);
    } 
  } 
